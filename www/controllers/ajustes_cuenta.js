...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (idCuenta > 0) {
        api_usuarioCuenta = `http://34.125.178.201/app/api/caseta/usuarios.php?id=${idCuenta}&action=`;
    } else {
        api_usuarioCuenta = 'http://34.125.178.201/app/api/caseta/usuarios.php?action=';
    }
