...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (idVi > 0) {
        api_visitaVi = `http://34.125.178.201/app/api/caseta/visitas.php?id=${idVi}&action=`;
    } else {
        api_visitaVi = 'http://34.125.178.201/app/api/caseta/visitas.php?action=';
    }
            ...
            <tr class="animate__animated animate__fadeIn">
                ...
                <th scope="row">
                    <div class="row paddingTh">
                        <div class="col-12">
                            <img src="http://34.125.178.201/resources/img/dashboard_img/residentes_fotos/${row.foto}" alt="#"
